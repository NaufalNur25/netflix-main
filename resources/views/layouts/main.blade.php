                ...
                <div class="">
                    <section id="browse-dashboard" class=" d-flex direction-column flex-start middle-align">
                        <div>
                            ...
                            poster="{{asset('images/tv-show/poster/never-have-ever-tv-show.webp')}}">
                            <source src="{{asset('images/tv-show/videos/Never Have I Ever - Official Trailer - Netflix_2.mp4')}}"
                            type="video/mp4">
